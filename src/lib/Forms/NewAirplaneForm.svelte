<script>
  ...
  async function insertNewAirplanes() {
    loading = true;
    error = null;
    try {
...
<div
  class="bg-white rounded-lg shadow sm:max-w-md sm:w-full sm:mx-auto sm:overflow-hidden my-[10%]"
>
